    ...
    <div ref={cardRef} className='ProductCard'>
      ...
      <div className='ProductCard-product-information'>
        {/* {props.product.photos.length > 1 ?
          <ThumbnailCarousel photos={props.product.photos} />
          : null
        } */}
        ...
        <div className='ProductCard-product-information-rating'>{props.product.rating ? <Stars avgQtr={props.product.rating} size={15} yellow={false}/> : "N/A"}</div>
      </div>
    </div>
  )
};
